...
RSpec.describe TestClassForMocks do
  ...
  context 'Scenario 2' do
    ...
    it 'should pass current expectations' do
      ...
      var_2173823440 = {val: 1, str: "hello world", message: "a message"}

      allow_any_instance_of(TestMockSubClass).to receive(:return_hash).and_return(var_2173823440)

      # TestClassForMocks#method_with_usage3 when passed message = "a message" should return {:val=>1, :str=>"hello world", :message=>"a message"}
      expect( @fixture.method_with_usage3("a message") ).to eq(var_2173823440)
