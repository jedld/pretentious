...
class TestClass1Scenario2 < TestClass1Test
  ...
  def test_current_expectation
    ...
    # TestClass1#set_block  should return #<Pretentious::RecordedProc:0x00000101f9e0a0@example.rb:73>
    assert_equal a, @fixture.set_block( &a)

    # TestClass1#call_block  should return {:hello=>"world", :test=>#<TestClass1:0x00000104a13948 @message="test", @_init_arguments={:params=>["test"], :params_types=>[[:req, :message]]}, @_variable_names={2186321240=>"message"}>, :arr_1=>[1, 2, 3, 4, 5, #<TestClass1:0x00000104a13948 @message="test", @_init_arguments={:params=>["test"], :params_types=>[[:req, :message]]}, @_variable_names={2186321240=>"message"}>], :sub_hash=>{:yes=>true, :obj=>#<TestClass1:0x00000104a13948 @message="test", @_init_arguments={:params=>["test"], :params_types=>[[:req, :message]]}, @_variable_names={2186321240=>"message"}>}}
...
class TestClass1Scenario3 < TestClass1Test
  ...
  def test_current_expectation
    ...
    # TestClass1#return_self when passed message = #<TestClass1:0x00000104a13948> should return #<TestClass1:0x00000104a13948>
...
class TestClass1Scenario4 < TestClass1Test
  ...
  def test_current_expectation
    # TestClass1#message  should return #<TestClass1:0x00000104a13948>
