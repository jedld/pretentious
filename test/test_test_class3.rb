...
class TestClass3Scenario1 < TestClass3Test
  def setup
      ...
      var_2164939620 = {hello: "world", test: another_object, arr_1: [1, 2, 3, 4, 5, another_object], sub_hash: {yes: true, obj: another_object}}
      testclass1 = TestClass1.new(var_2164939620)
