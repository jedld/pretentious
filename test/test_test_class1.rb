...
class TestClass1Scenario2 < TestClass1Test
  ...
  def test_current_expectation
    var_2193798520 = Proc.new { |message|
        @message
    }

    test_class1 = nil
    var_2193795760 = Proc.new { 
    ...
    #TestClass1#set_block  should return #<Pretentious::RecordedProc:0x00000105854700@example.rb:73>
    assert_equal var_2193798520, @fixture.set_block( &var_2193798520)

    #TestClass1#call_block  should return {:hello=>"world", :test=>#<TestClass1:0x00000102192ca8 @message="test", @_init_arguments={:params=>["test"], :params_types=>[[:req, :message]]}, @_variable_names={2165087660=>"message"}>, :arr_1=>[1, 2, 3, 4, 5, #<TestClass1:0x00000102192ca8 @message="test", @_init_arguments={:params=>["test"], :params_types=>[[:req, :message]]}, @_variable_names={2165087660=>"message"}>], :sub_hash=>{:yes=>true, :obj=>#<TestClass1:0x00000102192ca8 @message="test", @_init_arguments={:params=>["test"], :params_types=>[[:req, :message]]}, @_variable_names={2165087660=>"message"}>}}
    assert_equal @message, @fixture.call_block( &var_2193795760)
...
class TestClass1Scenario3 < TestClass1Test
  ...
  def test_current_expectation
    ...
    #TestClass1#return_self when passed message = #<TestClass1:0x00000102192ca8> should return #<TestClass1:0x00000102192ca8>
...
class TestClass1Scenario4 < TestClass1Test
  ...
  def test_current_expectation
    #TestClass1#message  should return #<TestClass1:0x00000102192ca8>
